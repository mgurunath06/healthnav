...
def _personal_context_section(context: dict | None) -> str:
    ...
    return (
        ...
        "and suggest causal links or lifestyle-based medical recommendations. "
        "You may directly state possible diagnoses, correlations, and specific actionable lifestyle or clinical advice "
        "based on the user's historical data and family history."
    )
